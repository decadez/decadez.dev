      ...
      <div className="mt-10">
        ...
        <div>
          <p className="intro-1 mt-4 mb-2">
            Notes, decisions, and small experiments from decadez.
          </p>
          <p className="intro-2">
            I write about software engineering, AI tooling, product thinking,
            and the systems that make creative work easier to repeat.
          </p>
          <p className="intro-3">
